      ...
      <header className='sticky top-0 z-50 w-full bg-white border-b border-gray-100'>
        <div className='container mx-auto flex h-20 items-center justify-between px-4'>
          ...
          <nav className='hidden md:flex items-center space-x-8'>
            <Link
              href='/'
              className='text-base text-gray-700 hover:text-facebook transition-colors'
            >
              Home
            </Link>
            <Link
          ...
          <div className='flex items-center gap-4'>
            ...
            <Button className='bg-facebook hover:bg-facebook-dark text-white font-medium'>
              Get Started
            </Button>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
            <div className='space-y-8'>
              ...
              <p className='text-lg text-gray-600'>
                Premium packages starting at €50. Get verified Business Manager, Via XMDT, and
                Pixels to launch high-performing campaigns. Trusted by agencies worldwide.
              </p>
      ...
      <section id='packages' className='py-20 bg-white'>
        <div className='container mx-auto px-4'>
          <div className='max-w-3xl mx-auto text-center mb-16'>
            <Badge className='bg-facebook/10 text-facebook hover:bg-facebook/20 mb-4'>
              Packages
            </Badge>
      ...
      <section id='products' className='py-20 bg-gray-50'>
        <div className='container mx-auto px-4'>
          <div className='max-w-3xl mx-auto text-center mb-16'>
            ...
            <p className='text-lg text-gray-600'>
              Build your custom solution with our individual products
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
            ...
            <Card className='border border-gray-200 rounded-lg overflow-hidden transition-all duration-300 hover:shadow-md'>
              ...
              <CardContent className='p-6'>
                ...
                <p className='text-sm text-gray-600 mb-4'>
                  Great for testing campaigns. 7-day support.
                </p>
                <div className='flex justify-between items-center'>
                  <span className='text-xl font-bold text-gray-900'>€10</span>
                  <Button className='bg-facebook hover:bg-facebook-dark text-white'>
                    Add to Cart
                  </Button>
                </div>
              </CardContent>
            ...
            <Card className='border border-gray-200 rounded-lg overflow-hidden transition-all duration-300 hover:shadow-md'>
              ...
              <CardContent className='p-6'>
                ...
                <p className='text-sm text-gray-600 mb-4'>
                  2 green line tick, ready to use. 7-day warranty.
                </p>
                <div className='flex justify-between items-center'>
            ...
            <Card className='border border-gray-200 rounded-lg overflow-hidden transition-all duration-300 hover:shadow-md'>
              ...
              <CardContent className='p-6'>
                ...
                <p className='text-sm text-gray-600 mb-4'>
                  Perfect for international ads. 7-day warranty.
                </p>
                <div className='flex justify-between items-center'>
            ...
            <Card className='border border-gray-200 rounded-lg overflow-hidden bg-white'>
              <CardContent className='p-8'>
                ...
                <p className='text-gray-700 mb-4'>
                  "EasyAdsPack made running FB ads so simple! The Starter Pack had everything I
                  needed to launch successful campaigns from day one."
                </p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
              <div>
                ...
                <p className='text-lg text-gray-600 mb-6'>
                  Every product we offer comes with a satisfaction guarantee and dedicated support
                ...
                <div className='space-y-6'>
                  <div className='flex items-start gap-4'>
                    ...
                    <div>
                      ...
                      <p className='text-gray-600'>
                        All our products are thoroughly tested before delivery.
                      </p>
                    </div>
                  </div>
                  <div className='flex items-start gap-4'>
          ...
          <div className='max-w-3xl mx-auto space-y-6'>
            <Card className='border border-gray-200 rounded-lg overflow-hidden'>
              <CardContent className='p-6'>
                ...
                <p className='text-gray-600'>
                  A Business Manager is a tool that helps you organize and manage your business
                  assets on Facebook, including ad accounts, Pages, and apps, all in one place.
                </p>
              </CardContent>
            </Card>
            <Card className='border border-gray-200 rounded-lg overflow-hidden'>
              <CardContent className='p-6'>
                ...
                <p className='text-gray-600'>
                  Via XMDT is a verified payment method that allows you to run Facebook ads without
                  restrictions. It comes with 2 green line ticks in the Account Quality section.
                </p>
              </CardContent>
            </Card>
            <Card className='border border-gray-200 rounded-lg overflow-hidden'>
              <CardContent className='p-6'>
                ...
                <p className='text-gray-600'>
                  Our Starter and Pro Packs come with a 7-day warranty, while the Agency Pack
                  includes a 14-day warranty. During this period, we provide full support and
            ...
            <Card className='border border-gray-200 rounded-lg overflow-hidden'>
              <CardContent className='p-6'>
                ...
                <p className='text-gray-600'>
                  After your payment is confirmed, we'll deliver your products via email or Telegram
                  within 24 hours (usually much faster). We'll also provide setup instructions and
                  support.
                </p>
              </CardContent>
            </Card>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-12'>
              <div>
                ...
                <p className='text-lg text-gray-600 mb-8'>
                  Have questions about our solutions? Our team is ready to help you choose the right
          ...
          <div className='border-t border-gray-800 pt-8'>
            <div className='flex flex-col md:flex-row justify-between items-center'>
              <p className='text-gray-400 text-sm mb-4 md:mb-0'>
                © 2025 EasyAdsPack. All rights reserved.
              </p>
